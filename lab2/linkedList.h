...
virtual void deleteAllOccurrences(Type info) = 0;
// Add other abstract functions as needed.
...
protected:
  int count = 0;                   // variable to store the number of
                                   // elements in the list
  nodeType<Type> *first = nullptr; // pointer to the first node of the list
  nodeType<Type> *last = nullptr;  // pointer to the last node of the list
private:
